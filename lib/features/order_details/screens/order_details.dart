...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  // !!! ONLY FOR ADMIN!!!
  void changeOrderStatus(int status, BuildContext context) {
    BlocProvider.of<AdminServicesCubit>(context).changeOrderStatus(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<AdminServicesCubit, BaseState>(
                      ...
                      controlsBuilder: (context, details) {
                        if ((context.read<UserDetailCubit>().state
                          ...
                          return CustomButton(
                            ...
                            onTap: () =>
                                changeOrderStatus(details.currentStep, context),
                          );
                        }
