...
class AuthServiceCubit extends Cubit<BaseState> {
  ...
  AuthServiceCubit({required this.signInUseCase, required this.signUpUseCase}) : super(StateInitial());
  ...
  signIn(String email, String password) {
    ...
    signInUseCase.call(Params2(email, password))!.then((value) => value!
        .fold((l) => emit(Unauthenticated()),
