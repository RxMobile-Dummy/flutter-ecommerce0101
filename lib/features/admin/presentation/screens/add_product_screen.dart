...
class AddProductScreen extends StatelessWidget {
  ...
  void sellProduct(List<File> images, BuildContext context) {
    if (_addProductFormKey.currentState!.validate() && images.isNotEmpty) {
      BlocProvider.of<AdminServicesCubit>(context).sellProduct(
          (context.read<UserDetailCubit>().state as Authenticated)
              .userEntity
              .token
              .toString(),
          context.read<GetProductCategoriesCubit>().productNameController.text,
          context.read<GetProductCategoriesCubit>().descriptionController.text,
          double.parse(
              context.read<GetProductCategoriesCubit>().priceController.text),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: BlocListener<AdminServicesCubit, BaseState>(
                ...
                children: [
                  ...
                  BlocBuilder<SelectImageCubit, BaseState>(
                    builder: (context, state) {
                      if (state is StateOnSuccess) {
                        List<File> listFile = state.response as List<File>;
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              CustomButton(
                                ...
                                onTap: () => sellProduct(
                                    context.read<SelectImageCubit>().list ?? [],
                                    context),
                              ),
                            ],
                          );
